...
def evaluar_optico():
    ...
    output_md = os.path.join(BASE_DIR, "test", "dataset", "metrics_tesseract_opencv_optico.md")
    output_csv = os.path.join(BASE_DIR, "test", "dataset", "metrics_tesseract_opencv_optico.csv")
    ...
    with open(output_md, "w", encoding="utf-8") as f:
        f.write("# Reporte de Evaluación Óptica (OCR) - Tesseract + OpenCV\n\n")
